...
INSERT INTO `core_mfg_manufacturers` (`id`,`name`) VALUES 
 (1,'APCL'),
 (2,'ISL'),
 (3,'IDB'),
 (4,'Abdullah');
...
--
-- Definition of table `core_mfg_product`
--

DROP TABLE IF EXISTS `core_mfg_product`;
CREATE TABLE `core_mfg_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `core_mfg_product`
--

/*!40000 ALTER TABLE `core_mfg_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_mfg_product` ENABLE KEYS */;
...
INSERT INTO `core_mfg_product_category` (`id`,`name`,`section_id`,`created_at`,`updated_at`) VALUES 
