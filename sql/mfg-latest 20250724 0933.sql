...
INSERT INTO `core_mfg_bom_details` (`id`,`bom_id`,`item_id`,`unit_id`,`qty`,`created_at`,`updated_at`,`price`) VALUES 
 ...
 (9,8,0,1,'779',NULL,NULL,377),
 (10,8,0,3,'662',NULL,NULL,501),
 (11,9,0,4,'10',NULL,NULL,10),
 (12,9,0,11,'2',NULL,NULL,10),
 (13,10,0,9,'327',NULL,NULL,74),
 (14,10,0,5,'34',NULL,NULL,567);
...
INSERT INTO `core_mfg_boms` (`id`,`bom_no`,`name`,`product_id`,`qty`,`labour_cost`,`unit_id`) VALUES 
 ...
 (8,'#BOM-03533','Xantha Beard',0,'0',29,0),
 (9,'#BOM-03533','Cake',0,'0',50,0),
 (10,'#BOM-03533','Tatum Lane',0,'0',54,0);
...
INSERT INTO `core_mfg_customers` (`id`,`name`,`mobile`,`email`,`created_at`,`updated_at`,`address`,`photo`) VALUES 
 ...
 (36,'Madeline Rosa','Aliquip aut dolor no','vihi@mailinator.com','2025-07-23 10:31:48','2025-07-23 10:31:48','Deleniti ea ut labor',NULL);
...
INSERT INTO `core_mfg_money_receipt_details` (`id`,`money_receipt_id`,`product_id`,`price`,`qty`,`vat`,`discount`) VALUES 
 ...
 (29,39,50,323,1,0,0),
 (30,40,50,333,1,0,0),
 (31,43,8,842,416,17,2),
 (32,44,2,207,43,28,28),
 (33,45,1,65,827,50,19),
 (34,46,8,663,69,99,29),
 (35,46,3,390,324,12,17),
 (36,46,5,933,555,36,85);
...
INSERT INTO `core_mfg_money_receipts` (`id`,`created_at`,`updated_at`,`customer_id`,`remark`,`receipt_total`,`discount`,`vat`) VALUES 
 ...
 (41,'2025-07-23 13:06:26','2025-07-23 13:06:26',30,'Sit qui dolor quae a',350276,11,0),
 (42,'2025-07-23 13:07:30','2025-07-23 13:07:30',30,'Sit qui dolor quae a',350276,11,0),
 (43,'2025-07-23 13:09:10','2025-07-23 13:09:10',30,'Sit qui dolor quae a',350276,11,0),
 (44,'2025-07-23 13:09:58','2025-07-23 13:09:58',29,'Dolor esse officia n',8807,94,0),
 (45,'2025-07-23 13:11:32','2025-07-23 13:11:32',15,'Natus modi asperiore',53686,100,0),
 (46,'2025-07-23 13:14:16','2025-07-23 13:14:16',12,'Officia eius hic vel',689888,50,0);
...
--
-- Definition of table `core_mfg_product_categories`
--

DROP TABLE IF EXISTS `core_mfg_product_categories`;
CREATE TABLE `core_mfg_product_categories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(45) NOT NULL,
...
--
-- Dumping data for table `core_mfg_product_categories`
--

/*!40000 ALTER TABLE `core_mfg_product_categories` DISABLE KEYS */;
INSERT INTO `core_mfg_product_categories` (`id`,`name`,`product_section_id`,`created_at`,`updated_at`) VALUES 
...
/*!40000 ALTER TABLE `core_mfg_product_categories` ENABLE KEYS */;
...
CREATE TABLE `core_mfg_production_orders` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `production_order_number` (`production_order_number`)
...
INSERT INTO `core_mfg_production_orders` (`id`,`production_order_number`,`product_id`,`warehouse_id`,`quantity`,`status`,`scheduled_date`,`started_at`,`completed_at`,`remarks`,`created_at`,`updated_at`) VALUES 
 (1,'PO-202507-001',1,1,'100.00','Pending','2025-07-25',NULL,NULL,'Production for Product ID 1','2025-07-24 09:29:03','2025-07-24 09:29:03'),
 (2,'PO-202507-002',2,1,'250.00','In Progress','2025-07-20','2025-07-20 09:00:00',NULL,'Ongoing batch for Product 2','2025-07-24 09:29:03','2025-07-24 09:29:03'),
 (3,'PO-202507-003',3,2,'300.00','Completed','2025-07-10','2025-07-10 08:00:00','2025-07-12 16:30:00','Finished successfully','2025-07-24 09:29:03','2025-07-24 09:29:03'),
 (4,'PO-202507-004',1,3,'150.00','Cancelled','2025-07-18',NULL,NULL,'Cancelled due to raw material shortage','2025-07-24 09:29:03','2025-07-24 09:29:03');
...
INSERT INTO `core_mfg_productions` (`id`,`bom_id`,`warehouse_id`,`uom_id`,`created_at`,`updated_at`,`price`,`product_name`,`manufacturer_id`,`product_category_id`) VALUES 
 (1,8,1,13,'2025-07-22 13:47:41','2025-07-22 13:47:41','109.00','Mufutau Walls',5,13),
 (2,9,3,2,'2025-07-22 13:47:52','2025-07-22 13:47:52','58.00','Sydnee Greene',2,6);
...
INSERT INTO `core_mfg_products` (`id`,`name`,`price`,`manufacturer_id`,`bom_id`,`product_category_id`,`uom_id`,`created_at`,`updated_at`) VALUES 
 (17,'Brown Borka',5500,1,0000000017,1,1,'0000-00-00 00:00:00','2025-04-28 12:08:58'),
 (46,'Shirt4',100,1,0000000046,1,1,'2025-04-08 11:56:43','2025-04-28 12:05:52'),
 (47,'Juta44',100,1,0000000047,1,1,'2025-04-08 15:30:20','2025-04-28 12:06:07'),
 (50,'Apple4rrr',100,1,0000000050,1,1,'2025-03-10 15:42:45','2025-04-28 12:06:27'),
 (52,'Oppo a3x',20000,1,0000000000,7,1,'2025-03-10 15:44:24','2025-03-10 15:44:24'),
 (100,'Jordan Velasquez',885,2,0000000007,10,15,'2025-07-22 13:40:27','2025-07-22 13:40:27'),
 (101,'Zeus Jarvis',655,3,0000000008,6,2,'2025-07-22 13:41:41','2025-07-22 13:41:41'),
 (102,'Mufutau Walls',109,5,0000000008,13,13,'2025-07-22 13:47:41','2025-07-22 13:47:41'),
 (103,'Sydnee Greene',58,2,0000000009,6,2,'2025-07-22 13:47:52','2025-07-22 13:47:52');
...
INSERT INTO `core_mfg_purchase_details` (`id`,`purchase_id`,`product_id`,`qty`,`price`,`vat`,`discount`,`created_at`,`updated_at`) VALUES 
 ...
 (73,83,2,172,542,94,11,'2025-07-22 04:16:45','2025-07-22 04:16:45'),
 (74,83,1,925,630,59,96,'2025-07-22 04:16:45','2025-07-22 04:16:45'),
 (75,84,3,134,236,66,82,'2025-07-22 06:20:26','2025-07-22 06:20:26'),
 (76,84,4,680,186,7,10,'2025-07-22 06:20:26','2025-07-22 06:20:26'),
 (77,85,3,134,236,66,82,'2025-07-22 06:20:28','2025-07-22 06:20:28'),
 (78,85,4,680,186,7,10,'2025-07-22 06:20:28','2025-07-22 06:20:28'),
 (79,86,4,437,673,65,67,'2025-07-22 06:21:16','2025-07-22 06:21:16'),
 (80,86,1,652,35,77,99,'2025-07-22 06:21:16','2025-07-22 06:21:16'),
 (81,87,1,676,547,17,62,'2025-07-22 06:22:19','2025-07-22 06:22:19'),
 (82,88,5,451,37,77,88,'2025-07-22 12:24:08','2025-07-22 12:24:08'),
 (83,89,2,835,524,31,40,'2025-07-23 10:04:40','2025-07-23 10:04:40'),
 (84,89,10,383,514,27,32,'2025-07-23 10:04:40','2025-07-23 10:04:40'),
 (85,89,7,801,953,26,70,'2025-07-23 10:04:40','2025-07-23 10:04:40'),
 (86,90,2,726,135,32,3,'2025-07-23 10:05:27','2025-07-23 10:05:27'),
 (87,90,2,705,501,44,58,'2025-07-23 10:05:27','2025-07-23 10:05:27'),
 (88,91,6,568,645,65,7,'2025-07-24 09:17:54','2025-07-24 09:17:54'),
 (89,91,5,261,25,31,41,'2025-07-24 09:17:54','2025-07-24 09:17:54');
...
INSERT INTO `core_mfg_purchases` (`id`,`supplier_id`,`purchase_date`,`delivery_date`,`shipping_address`,`purchase_total`,`paid_amount`,`remark`,`status_id`,`discount`,`vat`,`created_at`,`updated_at`) VALUES 
 ...
 (83,24,'2025-07-22 00:00:00','2000-03-25 00:00:00','Ad ut elit sed est',675040,675040,'Recusandae Cupidata',1,980,0,'2025-07-22 04:16:45','2025-07-22 04:16:45'),
 (84,8,'2025-07-22 00:00:00','1976-05-24 00:00:00','Aliquid temporibus e',31558,31558,'Aut possimus volupt',1,50,0,'2025-07-22 06:20:26','2025-07-22 06:20:26'),
 (85,8,'2025-07-22 00:00:00','1976-05-24 00:00:00','Aliquid temporibus e',31558,31558,'Aut possimus volupt',1,50,0,'2025-07-22 06:20:28','2025-07-22 06:20:28'),
 (86,4,'2025-07-22 00:00:00','2009-04-09 00:00:00','Alias aut nulla exce',316667,316667,'Quia incididunt est',1,230,0,'2025-07-22 06:21:16','2025-07-22 06:21:16'),
 (87,9,'2025-07-22 00:00:00','2003-03-18 00:00:00','Qui praesentium quos',369167,369167,'Rerum consequat Fug',1,560,0,'2025-07-22 06:22:19','2025-07-22 06:22:19'),
 (88,1,'2025-07-22 00:00:00','2023-05-29 00:00:00','Ipsum aut animi rer',16676,16676,'Doloribus saepe ulla',1,0,0,'2025-07-22 12:24:08','2025-07-22 12:24:08'),
 (89,1,'2025-07-23 00:00:00','2011-04-03 00:00:00','Rerum quasi illum e',1397137,1397137,'Soluta esse aliqua',1,560,0,'2025-07-23 10:04:40','2025-07-23 10:04:40'),
 (90,10,'2025-07-23 00:00:00','2002-12-19 00:00:00','Aliquam numquam expe',450730,450730,'Eiusmod velit accus',1,500,0,'2025-07-23 10:05:27','2025-07-23 10:05:27'),
 (91,8,'2025-07-24 00:00:00','1990-01-16 00:00:00','In blanditiis tempor',372900,372900,'Non aliquip dolore i',1,33,0,'2025-07-24 09:17:53','2025-07-24 09:17:53');
...
INSERT INTO `core_mfg_stocks` (`id`,`product_id`,`qty`,`transaction_type_id`,`remark`,`created_at`,`warehouse_id`,`product_type`,`product_name`) VALUES 
 ...
 (67,2,172,1,'Recusandae Cupidata','2025-07-22 04:16:45',1,'Raw Materials','Wheat Flour'),
 (68,1,925,1,'Recusandae Cupidata','2025-07-22 04:16:45',1,'Raw Materials','Sugar'),
 (69,3,134,1,'Aut possimus volupt','2025-07-22 06:20:26',1,'Raw Materials','Milk Powder'),
 (70,4,680,1,'Aut possimus volupt','2025-07-22 06:20:26',1,'Raw Materials','Citric Acid'),
 (71,3,134,1,'Aut possimus volupt','2025-07-22 06:20:28',1,'Raw Materials','Milk Powder'),
 (72,4,680,1,'Aut possimus volupt','2025-07-22 06:20:28',1,'Raw Materials','Citric Acid'),
 (73,4,437,1,'Quia incididunt est','2025-07-22 06:21:16',1,'Raw Materials','Citric Acid'),
 (74,1,652,1,'Quia incididunt est','2025-07-22 06:21:16',1,'Raw Materials','Sugar'),
 (75,1,676,1,'Rerum consequat Fug','2025-07-22 06:22:19',1,'Raw Materials','Sugar'),
 (76,5,451,1,'Doloribus saepe ulla','2025-07-22 12:24:08',1,'Raw Materials','Vanilla Essence'),
 (77,100,427,3,'Production','2025-07-22 13:40:27',2,'Finished Good','Jordan Velasquez'),
 (78,101,898,3,'Production','2025-07-22 13:41:41',1,'Finished Good','Zeus Jarvis'),
 (79,102,709,3,'Production','2025-07-22 13:47:41',1,'Finished Good','Mufutau Walls'),
 (80,103,848,3,'Production','2025-07-22 13:47:52',3,'Finished Good','Sydnee Greene'),
 (81,2,835,1,'Soluta esse aliqua','2025-07-23 10:04:40',1,'Raw Materials','Wheat Flour'),
 (82,10,383,1,'Soluta esse aliqua','2025-07-23 10:04:40',1,'Raw Materials','Sodium Benzoate'),
 (83,7,801,1,'Soluta esse aliqua','2025-07-23 10:04:40',1,'Raw Materials','Cocoa Powder'),
 (84,2,726,1,'Eiusmod velit accus','2025-07-23 10:05:27',1,'Raw Materials','Wheat Flour'),
 (85,2,705,1,'Eiusmod velit accus','2025-07-23 10:05:27',1,'Raw Materials','Wheat Flour'),
 (86,6,568,1,'Non aliquip dolore i','2025-07-24 09:17:54',1,'Raw Materials','Salt'),
 (87,5,261,1,'Non aliquip dolore i','2025-07-24 09:17:54',1,'Raw Materials','Vanilla Essence'),
 (88,100,347,55,'Minima maiores dolor','2025-07-24 09:19:03',1,'Cumque occaecat eum','Barbara Frederick');
...
--
-- Definition of table `core_mfg_tables`
--

DROP TABLE IF EXISTS `core_mfg_tables`;
CREATE TABLE `core_mfg_tables` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `core_mfg_tables`
--

/*!40000 ALTER TABLE `core_mfg_tables` DISABLE KEYS */;
INSERT INTO `core_mfg_tables` (`id`,`table_name`,`status`,`created_at`,`updated_at`) VALUES 
 (1,'core_mfg_products',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (2,'core_mfg_raw_materials',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (3,'core_mfg_suppliers',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (4,'core_mfg_purchase_orders',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (5,'core_mfg_purchase_returns',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (6,'core_mfg_bom_headers',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (7,'core_mfg_bom_items',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (8,'core_mfg_production_orders',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (9,'core_mfg_production_details',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (10,'core_mfg_inventory_levels',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (11,'core_mfg_sales_orders',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (12,'core_mfg_delivery_notes',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (13,'core_mfg_customers',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (14,'core_mfg_units',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (15,'core_mfg_warehouses',1,'2025-07-24 09:24:14','2025-07-24 09:24:14'),
 (16,'core_mfg_invoices',1,'2025-07-24 09:24:14','2025-07-24 09:24:14');
/*!40000 ALTER TABLE `core_mfg_tables` ENABLE KEYS */;
