    ...
    <div class="card bg-primary mb-3 p-4">
        <div class="row">
            <div class="col-12 d-flex justify-content-between align-item-center ">
                <h3 class=" card-title text-white d-flex align-items-center  m-0">Section List</h3>
                <a href="{{ route('sections.create') }}" class="btn btn-light btn-sm" title="Create New Product">
                    <i class="fa fa-plus mr-1"></i> Create New Section
                </a>
            </div>
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="min-width: 225px;">
                            <a href="{{ route('sections.show', $item->id) }}" class="btn btn-sm btn-info">View</a>
                            <a href="{{ route('sections.edit', $item->id) }}" class="btn btn-sm btn-warning">Edit</a>
