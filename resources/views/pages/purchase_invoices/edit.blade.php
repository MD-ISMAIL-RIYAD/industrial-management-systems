...
@section('page')
    ...
    <div class="card bg-primary mb-3 p-4">
        <div class="row">
            <div class="col-12 d-flex justify-content-between align-item-center ">
                <h3 class=" card-title text-white d-flex align-items-center  m-0">Edit PurchaseInvoice</h3>
    ...
    <form action="{{ route('purchase_invoices.update', $purchaseInvoice->id) }}" method="POST" enctype="multipart/form-data">
        @include('pages.purchase_invoices._form', ['mode' => 'edit', 'purchaseInvoice' => $purchaseInvoice])
    </form>
@endsection