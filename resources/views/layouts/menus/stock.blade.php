  <a class="nav-link dropdown-indicator" href="#stock" role="button"
    data-bs-toggle="collapse" aria-expanded="false" aria-controls="stock">
    <div class="d-flex align-items-center"><span class="nav-link-icon"><span
          class="fas fa-graduation-cap"></span></span><span class="nav-link-text ps-1">Stock</span>
    </div>
  </a>
  <ul class="nav collapse" id="stock">
    ...
    <li class="nav-item">
      ...
      <ul class="nav collapse" id="course">
        <li class="nav-item"><a class="nav-link" href="app/e-learning/course/course-list.html">
            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Create Adjustment</span>
            </div>
          </a>
          <!-- more inner pages-->
        </li>
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-indicator" href="#course" data-bs-toggle="collapse"
        ...
        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Transfer</span>
        </div>
      </a>
      <!-- more inner pages-->
      <ul class="nav collapse" id="course">
        <li class="nav-item"><a class="nav-link" href="app/e-learning/course/course-list.html">
            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Create Transfer</span>
            </div>
          </a>
          <!-- more inner pages-->
        </li>
        <li class="nav-item"><a class="nav-link" href="app/e-learning/course/course-grid.html">
            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Manage Transfer</span>
            </div>
          </a>
          <!-- more inner pages-->
        </li>
