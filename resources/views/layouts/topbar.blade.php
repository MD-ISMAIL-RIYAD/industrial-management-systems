<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
  ...
  <a class="navbar-brand me-1 me-sm-3" href="/">
    <div class="d-flex align-items-center"><img class="me-2"
        src="{{asset('assets/img/icons/spot-illustrations/intellect')}}.png" alt="" width="40" /><span
        class="font-sans-serif">@RIAYD</span>
    </div>
  </a>
          ...
          <div class="scrollbar list py-3" style="max-height: 24rem;">
            ...
            <a class="dropdown-item px-x1 py-2" href="#!">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-1">
                  <h6 class="mb-0 title">@RIAYD v10.8.2</h6>
            ...
            <div class="list-group list-group-flush fw-normal fs--1">
              ...
              <div class="list-group-item">
                <a class="notification notification-flush notification-unread" href="#!">
                  ...
                  <div class="notification-body">
                    <p class="mb-1"><strong>Albert Brooks</strong> reacted to <strong>Foiza Khalifa</strong>
                      status</p>
              ...
              <div class="list-group-item">
                <a class="notification notification-flush" href="#!">
                  ...
                  <div class="notification-body">
                    <p class="mb-1">The forecast today shows a low of 20 &#8451; in Dhaka. See today's
                      weather.</p>
                    <span class="notification-time"><span class="me-2" role="img"
              ...
              <div class="list-group-item">
                <a class="border-bottom-0 notification-unread  notification notification-flush" href="#!">
                  ...
                  <div class="notification-body">
                    <p class="mb-1"><strong>University of Dhaka</strong> created an event : "Causal Inference
                      Hilary 2019"</p>
                    <span class="notification-time"><span class="me-2" role="img"
              ...
              <div class="list-group-item">
                <a class="border-bottom-0 notification notification-flush" href="#!">
                  ...
                  <div class="notification-body">
                    <p class="mb-1"><strong>James Cameron</strong> invited to join the group: Bangladesh for Children's Fund</p>
                    <span class="notification-time"><span class="me-2" role="img"
            ...
            <div class="card-body px-3">
              <div class="row text-center gx-0 gy-0">
                <div class="col-4"><a
                    ...
                    <div class="avatar avatar-2xl"> <img class="rounded-c{{asset('ircle" src="assets/img')}}/team/3.jpg"
                        alt="" /></div>
                ...
                <div class="col-4"><a
                    ...
                    target="_blank"><img class="rounded" src="{{asset('assets/img/nav-icons/xbox.png')}}" alt="" width="40"
                      height="40" />
                    <p class="mb-0 fw-medium text-800 text-truncate fs--2 pt-1">X-Box</p>
                  </a></div>
                <div class="col-4"><a
                    class="d-block hover-bg-200 px-2 py-3 rounded-3 text-center text-decoration-none" href="#!"
